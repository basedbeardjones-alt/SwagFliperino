...
public class HighlightColorController {
    ...
    // ✅ Solid inventory highlight (100% opaque)
    private static final Color INV_SOLID = new Color(22, 58, 82, 255);
    ...
    // ✅ New: solid inventory highlight (no drift / no pulsing)
    public Color getInventorySolidColor() {
        return INV_SOLID;
    }
